...
BEGIN
  ...
  SELECT TOP (@num_sql)
    'TopSQL' as customType, @@SERVERNAME AS sql_hostname, ISNULL(DB_NAME(qt.dbid),'') as database_name,
...
drop table #temp_exec_query_stats;
drop table #temp_rtn_query_stats;
go
